...
<div class="container mt-5">
  ...
  <form action="gestion-regiones" method="GET" class="mb-4 row g-2">
    ...
    <div class="col-md-5">
      <input type="text" class="form-control shadow-sm" name="qProf" placeholder="Nombre del profesor..."
             value="<%= request.getAttribute("qProf") != null ? request.getAttribute("qProf") : "" %>">
    </div>
    <div class="col-md-2">
