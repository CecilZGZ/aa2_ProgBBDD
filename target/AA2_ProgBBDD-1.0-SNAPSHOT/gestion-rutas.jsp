...
<div class="container mt-5">
  ...
  <form action="gestion-rutas" method="GET" class="mb-4 row g-2">
    ...
    <div class="col-md-5">
      <input type="text" class="form-control shadow-sm" name="qClima" placeholder="Clima (ej. Soleado)..." value="<%= request.getAttribute("qClima") != null ? request.getAttribute("qClima") : "" %>">
    </div>
    <div class="col-md-2">
